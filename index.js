import{a as u,S as p,i as l}from"./assets/vendor-BGqwtSVv.js";(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))o(t);new MutationObserver(t=>{for(const r of t)if(r.type==="childList")for(const i of r.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&o(i)}).observe(document,{childList:!0,subtree:!0});function e(t){const r={};return t.integrity&&(r.integrity=t.integrity),t.referrerPolicy&&(r.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?r.credentials="include":t.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function o(t){if(t.ep)return;t.ep=!0;const r=e(t);fetch(t.href,r)}})();const f="https://pixabay.com/api/",g=void 0;function y(a){const s={q:a,image_type:"photo",orientation:"horizontal",safesearch:"true",key:g};return u.get(f,{params:s}).then(({data:e})=>e)}const c=document.querySelector(".loader"),m=document.querySelector(".gallery"),d={captionsData:"alt",captionDelay:250,className:"lightbox-custom"},h=new p(".open-modal-link",d);function b(a){const s=a.map(e=>`
